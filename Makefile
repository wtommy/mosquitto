...
dist : reallyclean
	...
	cp -r client logo man misc security service src ChangeLog.txt COPYING Makefile compiling.txt config.h config.mk readme.txt mosquitto.conf dist/mosquitto-${VERSION}/
