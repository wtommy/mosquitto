...
dist : reallyclean
	...
	cp -r client compat lib logo man misc security service src ChangeLog.txt CMakeLists.txt COPYING Makefile compiling.txt config.h config.mk readme.txt mosquitto.conf pwfile.example dist/mosquitto-${VERSION}/
